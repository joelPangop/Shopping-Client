...
got.ParseError = createErrorClass('ParseError', function (e, statusCode, opts, data) {
	...
	this.messageWrite = `${e.message} in "${urlLib.format(opts)}": \n${data.slice(0, 77)}...`;
});
...
got.HTTPError = createErrorClass('HTTPError', function (statusCode, opts) {
	...
	this.statusCode = statusCode;
	this.statusMessage = http.STATUS_CODES[this.statusCode];
	this.messageWrite = `Response code ${this.statusCode} (${this.statusMessage})`;
});
...
got.MaxRedirectsError = createErrorClass('MaxRedirectsError', function (statusCode, opts) {
	...
	this.statusCode = statusCode;
	this.statusMessage = http.STATUS_CODES[this.statusCode];
	this.messageWrite = 'Redirected 10 times. Aborting.';
});
